...
function Order(props) {
  ...
  return (
    <div className="myshop-inner detail">
      <Collapse defaultActiveKey={['1', '2', '3']} className="order-collapse order_info" expandIconPosition="end">
        <Panel header="주문정보" key="1" className="ordered_info">
          <div className="frm_row"><label className="frm_row-label">주문번호</label>
            {order.id}</div>
          <div className="frm_row"><label className="frm_row-label">주문일자</label>
            {order.date}</div>
          <div className="frm_row"><label className="frm_row-label">주문자</label>
            {order.name}</div>
          <div className="frm_row"><label className="frm_row-label">주문처리상태</label>
            {order.status}
          </div>
        </Panel>
      ...
      <div id="contents" className="orderform">
        {isLogin
          ? < div className="inner myshop-wrapper">
            ...
            <Order className="myshop-inner detail" order={order} />
          </div>
          : <>
            <h2 className="titleArea">주문상세조회</h2>
            <Order className="detail" order={order} />
          </>
        }
      </div>
    </>
