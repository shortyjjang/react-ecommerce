...
export default function Privacy() {
  return (
    <div id="contents" className="terms">
      <h2 className="titleArea">개인정보처리방침</h2>
      <div className="inner">
        (주)올투딜리셔스는 (이하 "회사"는) 고객님의 개인정보를 중요시하며, "개인정보 보호법" 등 관련 법령을 준수하고 있습니다.<br />
        ...
        - 필수정보: 이름, 로그인ID, 비밀번호, 휴대전화번호, 14세미만 가입자의 경우 법정대리인의 정보<br />
        - 선택정보: 생년월일, 성별<br />
        - 서비스 신청 시: 주소, 결제 정보<br />
        o 서비스 이용 과정이나 사업 처리 과정에서 서비스 이용 기록, 접속 로그, 쿠키, 접속 IP, 결제 기록, 불량 이용 기록이 생성되어 수집 될 수 있습니다.<br />
        <br />
        나. 수집방법<br />
        - 홈페이지, 서면 양식, 게시판, 이메일, 이벤트 응모, 배송 요청, 전화, 팩스, 생성 정보 수집 툴을 통한 수집<br />
        <br />
        <br />
        <strong>■ 개인정보의 수집 및 이용 목적</strong><br />
        <br />
        회사는 수집한 개인정보를 다음의 목적을 위해 활용합니다.<br />
        o 서비스 제공에 관한 계약 이행 및 서비스 제공에 따른 요금 정산<br />
        상품 제공, 구매 및 요금 결제, 물품 배송 또는 청구지 등 발송, 금융거래 본인 인증 및 금융 서비스<br />
        o 회원 관리<br />
        회원제 서비스 이용에 따른 본인확인, 개인 식별, 개인 식사 성향 분석 서비스, 불량회원의 부정 이용 방지와 비인가 사용 방지, 가입 의사 확인, 연령 확인, 만14세 미만 아동 개인정보 수집 시 법정 대리인 동의여부 확인, 불만처리 등 민원처리, 고지사항 전달<br />
        o 마케팅 및 광고에 활용<br />
        ...
        <br />
        o 위탁 대상자 : 씨제이대한통운(주)<br />
        o 위탁업무 내용 : 상품 배송 대행<br />
        o 보유기간 : 회원 탈퇴 시 또는 위탁 계약 종료 시까지<br />
        <br />
        o 위탁 대상자 : (주)KG이니시스<br />
        o 위탁업무 내용 : 상품 구매에 필요한 신용카드, 현금결제 등의 결제정보 전송<br />
        o 보유기간 : 회원 탈퇴 시 또는 위탁 계약 종료 시까지<br />
        <br />
        o 위탁 대상자 : LG CNS<br />
        o 위탁업무 내용 : 서비스 신청, 결제 및 환불 시 카카오 알림톡 발송을 위한 중개서비스<br />
        o 보유기간 : 수집 및 이용 목적 달성시까지<br />
        <br />
        <br />
        ...
        성명: 김진환<br />
        소속: (주)올투딜리셔스 예스어스<br />
        전화번호: 010-3377-3054<br />
        이메일: redwolf@a2dcorp.co.kr<br />
        <br />
        o 개인정보보호담당자<br />
        성명: 김진환<br />
        소속: (주)올투딜리셔스 예스어스<br />
        ...
        <br />
        <br />
        <strong>■ 개인정보의 안정성 확보조치</strong><br />
        <br />
        o 개인정보 암호화<br />
        이용자의 개인정보는 비밀번호에 의해 보호되며, 중요한 데이터는 저장 및 데이터 전송 시 암호화하여 보안 기능을 통해 보호하고 있습니다.<br />
        1) 저장 데이터 암호화: AES-256 키 암호화를 사용해서 AWS에서 저장된 상태로 서비스 데이터를 암호화합니다.<br />
        2) 이동 데이터 암호화: 업계 표준을 통해 Zendesk 서버와 회사의 커뮤니케이션이 암호화됩니다.<br />
        <br />
        o 해킹 등에 대비한 기술적 대책<br />
        회사는 해킹이나 컴퓨터 바이러스 등에 의해 이용자의 개인정보가 유출되거나 훼손되는 것을 막기 위해 최선을 다하고 있습니다.<br />
        o 내부관리계획의 수립 및 개인정보 취급 임직원의 최소화 및 교육<br />
        <br />
        회사는 개인정보보호를 위하여 내부관리계획을 수립하여 시행하고 있으며, 개인정보 관련 취급 임직원은 개인정보관리책임자 및 담당자 등 개인정보관리업무를 수행하는 자에 한정시키고 있고, 담당자에 대한 수시 교육을 통하여 개인정보보호방침의 준수를 항상 강조하고 있습니다.<br />
        <br />
        o 아이디와 비밀번호 관리<br />
        이용자의 개인정보는 비밀번호에 의해 보호되며 회사는 이용자의 부주의로 아이디, 비밀번호가 유출되어 발생한 문제와 기본적인 인터넷의 위험성으로 일어나는 일들에 대해 책임을 지지 않습니다. 비밀번호를 자주 변경하며 공용PC에서 로그인 시 개인정보가 유출되지 않도록 각별한 주의를 기울여 주시기 바랍니다.<br />
        <br />
        <br />
        <strong>■ 개인정보처리방침의 변경</strong><br />
        <br />
        회사는 개인정보 취급 방침 내용 추가, 삭제 및 수정이 있을 시에는 변경사항의 시행일 7일 전부터 사이트의 공지사항을 통해 고지하고, 개정 내용이 이용자에게 불리할 경우에는 30일간 공지사항 및 회원 전자우편 등을 통해 고지합니다.<br />
        <br />
      </div>
    </div>
  )
